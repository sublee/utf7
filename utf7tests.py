...
def test_pack_bytes(utf7):
    ...
    assert utf7.pack_bytes(65536) == b'\x80\x80\x04'
...
def test_unpack_bytes(utf7):
    ...
    assert utf7.unpack_bytes(b'\x80\x80\x04') == 65536
...
def test_socket(utf7):
    ...
    assert utf7.pack_socket(65536, client_sock) == 3
    assert utf7.unpack_socket(peer_sock) == 65536
    assert utf7.pack_socket(65536, peer_sock) == 3
    assert utf7.unpack_socket(client_sock) == 65536
